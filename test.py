...
from PySide6.QtGui import QPainter, QFont, QFontMetrics, QTextCursor, QColor, QPen
...
class VerticalColumnTextEdit(QPlainTextEdit):
    ...
    def paintEvent(self, event):
        ...
        if self.cursor_position and self.cursor_visible:
            cursor_rect = QRectF(self.cursor_position[0], self.cursor_position[1], 2, self.line_height)  # 细长的竖线
